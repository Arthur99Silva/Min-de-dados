...
for city in cities:
    # Filtrar os dados climáticos para a cidade atual
    ...
    # Se não houver dados combinados, continuar para a próxima cidade
    if df_merged_city.empty:
        continue

    # Aplicar correlação para feijão, milho e trigo
    ...
    # Adicionar o nome da cidade aos resultados
