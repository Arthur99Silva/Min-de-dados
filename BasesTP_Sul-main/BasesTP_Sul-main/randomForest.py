...
print("\nO gráfico de correlação foi salvo como 'correlacao_heatmap.png'.")
...
# Definir hiperparâmetros ajustados para evitar overfitting
param_grid = {
...
print("\nO gráfico de importância das variáveis foi salvo como 'importancia_variaveis.png'.")
